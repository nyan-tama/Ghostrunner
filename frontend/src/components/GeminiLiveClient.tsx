...
export default function GeminiLiveClient() {
  const {
    ...
    systemInstruction: "You are a helpful voice assistant. Respond in a conversational and friendly manner.",
  });
  ...
  return (
    <div className="max-w-[600px] mx-auto px-5 py-10 bg-gray-100 min-h-screen">
      ...
      <div className="mt-12 text-gray-500 text-sm text-center">
        <p className="mb-2">
          1. Click &quot;Connect&quot; to establish connection with Gemini Live API
        </p>
        <p className="mb-2">
